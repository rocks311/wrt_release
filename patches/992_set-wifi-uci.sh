...
jdc_ax1800_pro_wifi_cfg() {
    configure_wifi 0 149 HE80 20 'LiBwrt-5G' '12345678'
    configure_wifi 1 1 HE20 20 'LiBwrt' '12345678'
}

jdc_ax6600_wifi_cfg() {
    configure_wifi 0 149 HE80 22 'LiBwrt-5G1' '12345678'
    configure_wifi 1 1 HE20 22 'LiBwrt' '12345678'
    configure_wifi 2 44 HE160 23 'LiBwrt-5G2' '12345678'
}
