...
jdc_ax1800_pro_wifi_cfg() {
    configure_wifi 0 149 HE80 20 'AX1800_5G' '12345678'
    configure_wifi 1 1 HE20 20 'AX1800' '12345678'
}

jdc_ax6600_wifi_cfg() {
    configure_wifi 0 149 HE80 22 'AX6600_5G1' '12345678'
    configure_wifi 1 1 HE20 22 'AX6600' '12345678'
    configure_wifi 2 44 HE160 23 'AX6600_5G2' '12345678'
}
